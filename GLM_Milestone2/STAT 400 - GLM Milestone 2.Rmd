...
The research question of this logistic regression product is: what set of predictor variables, defensive or offensive, have higher predictive strength when predicting playoff appearances?
...
NBAPlayoffTeamsPerYear <- read.csv("data/RawData/NBA_Playoff_Data.csv")
```
