...
NBAGameData <- read.csv("regular_season_totals_2010_2024.csv")
## I manually made a csv from this site using Google Sheets: https://basketball.realgm.com/nba/playoffs/history/2010
NBAPlayoffTeamsPerYear <- read.csv("NBA_Playoff_Data.csv")
```


## GLM MILESTONE1 & GLM MILESTONE2 DATA CLEANING 
```{r}
