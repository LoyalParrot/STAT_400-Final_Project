...
The research question that our group asks is what is the association between a school's setting and their student's post test scores, controlling for the student's pretest, and whether teaching_method has an effect on this association?

## Research Question

The research question that our group asks is: how do student-level predictors (e.g., gender, pretest score, free/reduced lunch, and classroom-level factors (e.g., class size, teaching method) jointly influence student performance, after accounting for baseline differences across schools
...
The Level 2 Observational Units in our question are the schools. 

## Level 1 Variables

The Level 1 Variables are: `student_id`, `gender`, `lunch`, `pretest`, and `posttest`.

## Level 2 Variables

The Level 2 Variables are: `school`, `school_setting`, `school_type`, and `teaching_method`.

## Fixed Effects

The fixed effects for our research question are: `teaching_method`, `lunch`, `gender` and `pretest`

## Random Effects

The random effects for our research question are: the school.