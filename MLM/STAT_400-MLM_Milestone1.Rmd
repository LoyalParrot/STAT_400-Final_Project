...
The research question that our group asks is what is the association between a school's setting and their student's post test scores, and whether teaching_method has an effect on this association?
...
The Level 2 Observational Units are the individual classes.
...
The Level 2 Variables are: `school`, `school_setting`, `school_type`, `classroom`, `teaching_method`, and `n_student`.

## Fixed Effects

The fixed effects for our research question are: `teaching_method` and `school_setting`

## Random Effects

The random effects for our research question are: the student (which is identified by the unique `student_id`).